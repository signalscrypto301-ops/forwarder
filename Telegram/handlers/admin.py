...
async def help_command(message: Message):
    ...
    help_text = (
        ...
        "📱 /channels - Interactive channel browser with Pause/Resume & Unlink buttons\n"
        "⏸️ /deactivate &lt;channel_id&gt; - Pause/deactivate forwarding for a specific channel\n"
        "▶️ /activate &lt;channel_id&gt; - Resume/activate forwarding for a specific channel\n"
        "🔗 /unlink &lt;channel_id&gt; [group_id] - Unlink all or specific WhatsApp destination(s)\n"
